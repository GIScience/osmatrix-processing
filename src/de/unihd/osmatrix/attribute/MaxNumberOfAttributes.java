...
/**
 * The Class MaxNumberOfAttributes.
 */
public class MaxNumberOfAttributes extends Attribute{
	...
	public String getDescription() {
		return "The maximum number of attributes attached to any object within the given cell.";
...
//		return Arrays.asList(TABLE.LINE);
	...
	protected double doUpdate(TABLE table, long cell_id, double numAttributes,
			...
			numAttributes = Math.max(numAttributes,Utils.numberOfAttributes(row));			
